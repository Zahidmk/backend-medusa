...
async function upsertProduct(
  ...
  const metadata: Record<string, any> = {
    ...
    meta_title: p.meta_title || p.website_meta_title || p.seo_title || null,
    meta_description: p.meta_description || p.website_meta_description || p.seo_description || null,
    website_meta_title: p.website_meta_title || p.meta_title || p.seo_title || null,
    website_meta_description: p.website_meta_description || p.meta_description || p.seo_description || null,
    seo_title: p.website_meta_title || p.seo_title || p.meta_title || null,
    seo_description: p.website_meta_description || p.seo_description || p.meta_description || null,
